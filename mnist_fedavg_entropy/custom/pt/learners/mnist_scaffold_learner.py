...
import torch
from pt.learners.mnist_learner import MNISTLearner
...
class MNISTScaffoldLearner(MNISTLearner):
    def __init__(
        self,
    ...
    def initialize(self, parts: dict, fl_ctx: FLContext):
        ...
        MNISTLearner.initialize(self, parts=parts, fl_ctx=fl_ctx)
